app.factory('AmarEla', function($http, CONFIG) {	
    return {
        GetAlbumDetailsTypeWiseAPI: function(data) {
            ...
            var url = CONFIG.serverDetails.host + CONFIG.serverDetails.basepath + "album.php?get=ALBMTYPWISE&type="+params.type + '&api_key='+CONFIG.serverDetails.api_key + '&num_rec='+params.numRec;
